"""
Enhanced 5 Models Ensemble Inference
- 5개 모델의 예측을 결합하여 제출 파일 생성
- 모델: Model1, Model2, Model3, Model5_Enhanced, Model6_Enhanced
- 보팅 방식: 3개 이상 동의 시 수료(1) 예측
- Output: submission_enhanced_3agree.csv
"""
...
# ============================================================================
print("="*70)
print("Enhanced 5 Models Ensemble Inference")
print("="*70)

# 5개 모델 정의 (텍스트 3개 + 향상된 테이블 2개)
models = {
    ...
    'Model5_XGBoost_Enhanced': 'submission_model5_xgboost_enhanced.csv',
    'Model6_CatBoost_Enhanced': 'submission_model6_catboost_enhanced.csv',
}
...
# ============================================================================
print("\n" + "="*70)
print("Ensemble Voting (5 Enhanced Models)")
print("="*70)
...
# 3개 이상 동의 (meta_vote_both에서 사용)
submission_3agree = pd.DataFrame({
    'ID': test_ids,
    'completed': vote_df['vote_3'].values
})
submission_3agree.to_csv(OUTPUT_DIR / "submission_enhanced_3agree.csv", index=False)
print(f"\n* submission_enhanced_3agree.csv saved!")
...
submission_4agree.to_csv(OUTPUT_DIR / "submission_enhanced_4agree.csv", index=False)
print(f"\nsubmission_enhanced_4agree.csv saved!")
...
submission_5agree.to_csv(OUTPUT_DIR / "submission_enhanced_5agree.csv", index=False)
print(f"\nsubmission_enhanced_5agree.csv saved!")
